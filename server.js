...
app.post('/api/gemini', async (req, res) => {
  ...
  try {
    if (action === 'translate') {
      ...
      const { bodyPart, symptoms, lang, gender, age, condition, pain, since, medications, allergies } = req.body;
